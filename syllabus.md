...
There will be no readings for the last week  of the instruction. Hence, in total, you need to submit 8 reading summaries (week 2 - week 9) unless otherwise indicated by the instructor. 
...
- Completing course evaluations: Around the middle and end of the semester, we will send out a survey to help us understand how the course is going, and how we can improve. 
...
### Components 
- Programming Assignments:  9% + 12% + 14% =0.239 35%
- Exams: 45%
- Quizzes: 5%
- Scribe Duties: 5%
- Reading Summary: 10%
